...
class laptop extends komputer {
    ...
    public function display_processor() {
        return $this->jenis_processor; // Sekarang lancar karena sudah protected
    }
    ...
    public function display_ram2() {
        return $this->tampilkan_ram(); // Sekarang lancar karena sudah protected
    }
    ...
    // PERBAIKAN: Ubah private menjadi public/protected agar bisa dipanggil di luar class (Line 67)
